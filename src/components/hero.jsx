...
function Hero({ onNavigate }) {
  return (
    <section className="hero-section" id="home">
      <img className="hero-section__face" src={face} alt="" aria-hidden="true" />
      ...
      <div className="hero-section__marks" aria-hidden="true">
        <img className="hero-section__creative" src={creativeMonkeys} alt="" />
        <img className="hero-section__logo2" src={logo2} alt="" />
      </div>
